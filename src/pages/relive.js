...
const Relive = () => {
    ...
    const [videos] = useState([
        { id: 1, title: "ALAA JAZAERI - Freaks OF Nature E3: Freaks Of Araveia - Main Stage", thumbnail: videoimg },
    ]);
  ...
  const [showFilters, setShowFilters] = useState(false); 
    ...
    return (
      ...
      <div className="filter-responsive-bar" 
           style={{
                ...
                <hr/>
                  ...
                  <div className="relive-container">
                        ...
                        <div className="relive-content">
                            <div className="relive-content-image">
                                <img src={ReliveImg} alt="Freaks of Nature" className="img-fluid" />
                            </div>
                            <div className="relive-content-text">
                                <h2>ALAA JAZAERI - Freaks OF Nature E3: Freaks Of Araveia - Main Stage</h2>
                                <p>190 VIEWS</p>
                            </div>
                        </div>
                  </div>
