            ...
            <div className="episode-div">
                ...
                <div className="episode-content">
                    <div className="episode-box1">
                        ...
                        <p>It all started in 2021, as a small activation at XP Music. What was meant to be a one-off turned into something unforgettable — Episode 1: Freak Show. Ten local DJs took the stage, and a massive, electric crowd answered back. It wasn’t about perfection or polish; it was about energy, emotion, and a shared feeling that something new was happening.</p>
                        <p>
                        That night marked the birth of Freaks of Nature — a movement powered by creativity and community. It was the first time the Freaks came together, and from that moment, the path was clear. What began as an activation became the start of a cultural shift — the beginning of the Freak era.</p>
                    </div>
                ...
                <div className="episode-content res">
                   <div className="episode-box2">
                    ...
                    <div className="episode-box1">
                        ...
                        <p>Episode 2 marked a turning point — the first fully independent event ever licensed in Saudi Arabia. What began as a movement found its own ground, standing tall with two stages, over thirty DJs, and a crowd that matched the energy beat for beat. For the first time, James Hype brought his sound to Riyadh, adding international weight to a homegrown vision.</p>
                        <p>It wasn’t just a festival; it was proof that the scene was real — that creativity, discipline, and community could build something world-class from within Saudi. Freakfest didn’t follow a blueprint; it wrote its own. And in doing so, it cemented Freaks of Nature as a force ready to push boundaries and redefine what independence looks like in music.</p>
                    </div>
                </div>
            ...
            <div className="episode-div">
                ...
                <div className="episode-content">
                    <div className="episode-box1">
                        ...
                        <p >It was more than a festival — it was a statement of scale and identity. Freaks of Araveia introduced the first-ever Rule the Stage competition, opening the door for rising talent to perform alongside global names. It marked the moment Freaks of Nature evolved from a movement into a full-fledged cultural phenomenon — one that celebrates local creativity while connecting it to the world stage.</p>
                    </div>
                    <div className="episode-box2">
                ...
                <div className="episode-content res">
                   <div className="episode-box2">
                    ...
                    <div className="episode-box1">
                        ...
                        <p>Episode 4: XP Edition took place in November 2022 at JAX, Diriyah, as part of XP NITE — a cultural hotspot where music, art, and experimentation collide. The activation brought together a seamless mix of international and local talent, featuring Wedamnz, Rash, Sound of Yaz, and more, creating a night that felt both global and deeply rooted in the Saudi scene.</p>
                        <p>It was a reminder of how far the movement had come — from underground energy to recognized creative force. XP Edition wasn’t about scale; it was about connection. A raw, expressive moment that kept the Freak spirit alive in the heart of Riyadh’s creative district.</p>
                    </div>
                </div>
                ...
                <div className="episode-content res">
                   <div className="episode-box2">
                    ...
                    <div className="episode-box1">
                        ...
                        <p>Episode 6 marked the first-ever Freaks of Nature event in Europe, taking place in Amsterdam during the iconic Amsterdam Dance Event (ADE) in partnership with MMATH. The night featured six curated back-to-back sets blending international names with Saudi talent — a seamless mix of styles and stories that embodied the Freaks’ spirit of collaboration and experimentation.</p>
                        <p>In 2023, the brand took over the city with two shows in one night — a high-energy Showcase followed by a late-night Afterparty. The lineup included Wedamnz, Rash, Seth Hills, Brooks, Igniter, and B3, turning Amsterdam into a meeting point for East and West. ADE Edition wasn’t just an expansion; it was a statement — the Freaks had officially gone global.</p>
                    </div>
                </div>
            ...
            <div className="episode-div">
                ...
                <div className="episode-content res">
                    ...
                    <div className="episode-box1">
                        ...
                        <p>ADE Showcase marked the second edition of Freaks of Nature at Amsterdam Dance Event, a soft yet powerful beginning that set the tone for the brand’s legendary comeback after two years. In collaboration with MMATH, the event carried the same signature b2b format, pairing local and international talent in an atmosphere built on connection and creativity.</p>
                        <p>Held once again in Amsterdam, the lineup featured Igniter, Toby Romeo, Aeres, Hannah, Yunite, Justin Mylo, Brooks, Yaz, and Sam Collins — artists who bridged cultures and sounds in perfect sync. ADE Showcase wasn’t just another event; it was a quiet spark before the next big explosion — the reminder that the Freaks are never gone, just evolving.</p>
                    </div>
                    <div className="episode-box2">
