...
const WEEKEND_OPTIONS = [
    { idSuffix: 'weekend1', label: 'Weekend 1', dayLabel: 'Thursday', dateLabel: 'Jan 30' },
    { idSuffix: 'weekend2', label: 'Weekend 2', dayLabel: 'Friday', dateLabel: 'Jan 31' },
];

const DAY_OPTIONS = [
    { idSuffix: 'day1', label: 'Day 1', dayLabel: 'Thursday', dateLabel: 'Jan 30' },
